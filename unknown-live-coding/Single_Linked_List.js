...
someList.insert(100)
someList.insert(200, 2)
someList.insert(500, someList.size)

someList.remove(0)
someList.remove(2)
someList.remove(someList.size)

console.log("get", someList.get(0));
console.log("get", someList.get(2));
console.log("get", someList.get(someList.size - 1));

console.log(someList.toString());
someList.print()